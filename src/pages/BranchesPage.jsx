...
export default function BranchesPage() {
  ...
  const handleDeleteBranch = async (branchId) => {
    if (
      window.confirm(
        'Filialı silmək istədiyinizdən əminsiniz? Bu filialın bütün istifadəçi və masa məlumatları silinəcək.'
      )
    ) {
          ...
          {branches.length === 0 ? (
            <div className="bg-white rounded-lg shadow-md p-12 text-center">
              ...
              <p className="text-gray-600 mb-6">
                Restoranınızın filiallarını əlavə edərək istifadəçi və masa idarəetməsini
                asanlaşdırın
              </p>
              <button
                onClick={() => setShowModal(true)}
