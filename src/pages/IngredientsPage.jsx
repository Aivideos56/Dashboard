...
import { getIngredients, addIngredient, updateIngredient, deleteIngredient } from '../utils/supabase';
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">
              {searchTerm ? 'Nəticə tapılmadı' : 'Tərkib yoxdur'}
            </h3>
            <p className="text-gray-600 mb-6">
              {searchTerm
                ? 'Axtarış üçün başqa açar söz cəhd edin'
                : 'Başlamaq üçün ilk tərkibinizi əlavə edin'}
            </p>
            {!searchTerm && (
              <button
                onClick={handleAddIngredient}
                  ...
                  {filteredIngredients.map((ingredient) => {
                    ...
                    return (
                      <tr key={ingredient.id} className="hover:bg-gray-50 transition">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span
                            className={`px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full ${stockStatus.color}`}
                          >
                            {stockStatus.text}
                          </span>
                        </td>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl shadow-2xl max-w-md w-full p-6">
            ...
            <p className="text-gray-600 text-center mb-6">
              "{ingredientToDelete?.name}" tərkibini silmək istədiyinizdən əminsiniz? Bu
