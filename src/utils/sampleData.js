export const seedSampleData = async (storageUtils, restaurantId) => {
		...
		const products = [
			{
				...
				price: 3.5,
				cost: 1.2,
				category_id: addedCategories[0].id,
				sub_category_id: addedSubCategories[0].id,
			...
			},
			{
				...
				cost: 0.8,
				category_id: addedCategories[0].id,
				sub_category_id: addedSubCategories[1].id,
				restaurant_id: restaurantId,
				is_active: true,
			},
			{ name: 'Pizza Marqarita', price: 12.0, cost: 5.0, category_id: addedCategories[1].id, restaurant_id: restaurantId, is_active: true },
			{ name: 'Burger', price: 8.5, cost: 3.5, category_id: addedCategories[1].id, restaurant_id: restaurantId, is_active: true },
			{ name: 'Tiramisu', price: 6.5, cost: 2.5, category_id: addedCategories[2].id, restaurant_id: restaurantId, is_active: true },
		];
	...
	const sampleOrders = [
		...
		},
		{
			...
			table_number: 2,
			items: [
				{ name: 'Pizza Marqarita', price: 12.0, quantity: 1 },
				{ name: 'Cola', price: 2.5, quantity: 2 },
			],
			subtotal: 17.0,
			discount: 0,
			tax: 3.06,
